...
git config --global user.email 'dong4325@126.com'
...
#gitbash远程登陆linux服务器
ssh dong@192.168.1.160

#本地仓库推送到远程需要一对密钥，默认生成在改用户的.ssh目录下，后缀pub的为公钥，另一个为私钥，将公钥放在github上。
#-t即指定密钥的类型，密钥的类型有两种，一种是RSA，一种是DSA
#C表示要提供一个新注释，用于识别这个密钥，所以“”里面不一定非要填邮箱，可以是任何内容，邮箱仅仅是识别用的key
ssh-keygen -t rsa -C "dong4325@126.com"

#README.md文件不在本地代码目录中，出现错误。
...
> git的教程都讲的真烂！！
>
> 来源：[阮一峰的网络日志](http://www.ruanyifeng.com/blog/2015/12/git-cheat-sheet.html)